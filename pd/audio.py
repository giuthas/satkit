...
def band_pass(fs):
    logger.debug("Generating band-pass filter.")
    nyq = 0.5 * fs
    low = 950.0 / nyq
    high = 1050.0 / nyq
...
def detect_beep_and_speech(frames, fs, b, a, name):
    ...
    logger.info("Detecting beep onset and presence of speech in " + name + ".")
