...
def get_data_from_dir(directory):
    ...
    # TODO Removal of data directory from file name using '\\' (works on Windows... may not work on other systems...?)
    ...
    for i in range(0, len(filenames)):
        ...
        # Candidates for file names. Existence tested below.
